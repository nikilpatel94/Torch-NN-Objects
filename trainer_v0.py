...
class Torch_Trainer(nn.Module):
  def __init__(self,torch_model,train_data:list,validation_data:list,torch_optimizer,epochs=100,batch_maker_fn=None, **kwargs):
    super().__init__()
    ...
    self.epochs = epochs
    self.batch_maker_fn = kwargs['batch_maker_fn']
